...
export const ReservationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="reserveItApp.reservation.delete.question">
        <Translate contentKey="reserveItApp.reservation.delete.question" interpolate={{ id: reservationEntity.id }}>
