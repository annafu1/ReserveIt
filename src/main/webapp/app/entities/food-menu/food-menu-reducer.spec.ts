...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './food-menu.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FOODMENU_LIST actions', async () => {
    ...
    it('dispatches FETCH_FOODMENU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FOODMENU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FOODMENU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FOODMENU actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FOODMENU actions', async () => {
      const expectedActions = [
        {
