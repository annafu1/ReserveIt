...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESTAURANTTABLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_RESTAURANTTABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RESTAURANTTABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RESTAURANTTABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RESTAURANTTABLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RESTAURANTTABLE actions', async () => {
      const expectedActions = [
        {
