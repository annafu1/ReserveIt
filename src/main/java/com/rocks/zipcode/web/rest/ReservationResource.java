...
/**
 * REST controller for managing {@link com.rocks.zipcode.domain.Reservation}.
 */
@RestController
@RequestMapping("/api")
public class ReservationResource {
    ...
    public List<ReservationDTO> getAllReservations(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
