...
import com.rocks.zipcode.service.RestaurantTableService;
...
/**
 * REST controller for managing {@link com.rocks.zipcode.domain.RestaurantTable}.
 */
@RestController
@RequestMapping("/api")
public class RestaurantTableResource {
    ...
    public ResponseEntity<RestaurantTableDTO> updateRestaurantTable(
        ...
        RestaurantTableDTO result = restaurantTableService.update(restaurantTableDTO);
        return ResponseEntity
            .ok()
